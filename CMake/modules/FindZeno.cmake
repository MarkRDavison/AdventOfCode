...
IF(ZENO_INCLUDE_DIR) 
    IF (NOT ZENO_FIND_COMPONENTS)
        SET(ZENO_FIND_REQUIRED_AUDIO 1)
        SET(ZENO_FIND_REQUIRED_CORE 1)
        SET(ZENO_FIND_REQUIRED_GAME 1)
        SET(ZENO_FIND_REQUIRED_GRAPHICS 1)
        SET(ZENO_FIND_REQUIRED_UTILITY 1)
        SET(ZENO_FIND_REQUIRED_WINDOW 1)
    ENDIF ()
ENDIF()

IF (ZENO_FIND_REQUIRED_AUDIO)
    ...
    SET(ZENO_LIBRARIES ${ZENO_LIBRARIES}
        ${ZENO_LIBRARY_AUDIO}
    )
    #################
    #	OpenAl
    ...
    SET(ZENO_DEPENDENCIES ${ZENO_DEPENDENCIES}
        zeno-openal
    )
ENDIF()
IF (ZENO_FIND_REQUIRED_GAME)
...
ENDIF()
IF (ZENO_FIND_REQUIRED_GRAPHICS)
...
find_package_handle_standard_args(ZENO DEFAULT_MSG ZENO_LIBRARIES ZENO_INCLUDE_DIR)

mark_as_advanced(ZENO_INCLUDE_DIR ZENO_LIBRARIES) 